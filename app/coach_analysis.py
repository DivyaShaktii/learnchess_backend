...
CLASSIFICATION_PROMPTS = {
    "Book": [
        "Nice, you're right on track with the opening here.",
        "That's a familiar move, and a good one. Keep going.",
        "You know this one. It's a well-trodden path.",
        "Good, you're still following the classic ideas.",
        "Players have been choosing this move for years, and for good reason.",
        "That's a solid, standard choice. Nicely done.",
    ],
    "Brilliant": [
        "Wow, that's brilliant! You gave something up and it really pays off.",
        "Now that's a special move. You saw something most people would miss.",
        "I love it! That sacrifice was bold, and it works beautifully.",
        "That was a big idea, and you found it. Really well played.",
        "Brilliant! Brave, sharp, and exactly right.",
        "Look at you go! That sacrifice gives you a great position.",
    ],
    "Only Move": [
        "Great find! That was the one move that holds everything together.",
        "Well spotted. This position needed exactly that, and you delivered.",
        "That was the only move, and you found it. Really nice.",
        "Sharp thinking! Everything else would have caused trouble.",
        "That was a tough one, and you got it right. Good job.",
        "You kept your cool and found the key move. Well done.",
    ],
    "Great Move": [
        "Great move! That wasn't easy to find.",
        "Really nice. That's clearly one of the best options here.",
        "I like that a lot. It gives you excellent chances.",
        "Very well played. You picked the better path.",
        "That shows real understanding of the position. Keep it up.",
        "Good eye! That one was hidden pretty well.",
    ],
    "Best Move": [
        "That's the best move in the position. Excellent!",
        "You found the top choice. Perfect.",
        "Exactly what the engine would play. Well done!",
        "Spot on. That's the strongest move on the board.",
        "Beautiful, you found the most accurate move.",
        "That's it! It leads to the best continuation.",
    ],
    "Excellent": [
        "Excellent move. You're playing really well.",
        "Very accurate. Your position stays strong.",
        "That's a great choice, and you're not giving up anything.",
        "Nicely done. Your pieces are working well together.",
        "So close to the very best. You should be happy with that.",
        "That's a clean, confident move. Keep going.",
    ],
    "Good": [
        "Good move. Your position is in good shape.",
        "Nice, that's a sensible choice.",
        "That works well. You're doing fine.",
        "Solid move. Nothing to worry about here.",
        "You're on the right track. Keep it up.",
        "Well played. Simple and reliable.",
    ],
    "Inaccuracy": [
    ...
    "Opening Principle": [
        "Try to develop a piece or take some space in the center.",
        "Getting your pieces out will really help your position.",
        "Is there another piece you can bring into the game?",
        "Remember the basics: develop, control the center, and think about castling.",
        "Look for a move that improves your pieces and keeps your king safe.",
        "This is a great time to follow the opening basics.",
    ],
}
